<template>
<!-- http://testyx.aplusx.com/wximg/jiaxiao/firstbind.png -->
    <div class="wrap" style="background:url('http://yx.aplusx.com/wximg/jiaxiao/firstbind.png')no-repeat;background-size:100% 100%;">
      <div class="container">
          ...
          <!-- <div style="width:100%;">
            ...
            <p style="text-align:center;font-size:24rpx;color:blue;padding:20rpx 0;" @click="getReturn">返回首页</p>
          </div> -->
          <div class="bottom">
