<template>
  <div class="outDiv">
    <image src='http://yx.aplusx.com/wximg/jiaxiao/xc_fuli1.png' style="width:100%;height:395px;"></image>
    <div class="form_box">
      <div class='form_info'>
        <form action="">
           <!-- <input placeholder-style="color:red" placeholder="占位符字体是红色的" /> -->
           <i-input title="尊称" v-model.lazy = "name" placeholder="请输入尊称" @change="nameChange"/>
           <i-input title="手机" v-model.lazy = "phone" placeholder="请输入手机号" type="number" @change="phoneChange"/>
           <i-input title="备注" v-model.lazy = "node" placeholder="请输入意向车型、预算等"  @change="nodeChange"/>
        </form>
